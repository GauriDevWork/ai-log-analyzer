...
require_once __DIR__ . '/../src/Output/ConsoleFormatter.php';
require_once __DIR__ . '/../src/Output/JsonFormatter.php';
...
use AILogAnalyzer\Output\ConsoleFormatter;
use AILogAnalyzer\Output\JsonFormatter;
